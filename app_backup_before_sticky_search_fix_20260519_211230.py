...
APP_BUILD = "Codex 2026-05-19 sticky add storage"
            ...
            if (addMarker) {
                ...
                if (lotBlock && markerChild) {
                    ...
                    formParts.forEach(function(part) {
                        ...
                        part.style.setProperty('background', '#f0f4f8', 'important');
                        part.style.setProperty('box-shadow', '0 6px 14px rgba(15, 23, 42, 0.08)', 'important');
                        part.style.setProperty('padding', '0.15rem 0', 'important');
