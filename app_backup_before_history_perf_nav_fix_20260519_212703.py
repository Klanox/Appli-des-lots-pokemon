...
APP_BUILD = "Codex 2026-05-19 history sticky cleanup"
            ...
            if (addMarker) {
                ...
                if (lotBlock && markerChild) {
                    ...
                    formParts.forEach(function(part) {
                        ...
                        part.style.setProperty('border-left', '1px solid #dbe4ef', 'important');
                        part.style.setProperty('border-right', '1px solid #dbe4ef', 'important');
                        part.querySelectorAll('button').forEach(function(btn) {
                            btn.style.setProperty('width', '100%', 'important');
                        });
                        if (part === formParts[0]) {
                            part.style.setProperty('border-top', '1px solid #dbe4ef', 'important');
                            part.style.setProperty('border-radius', '12px 12px 0 0', 'important');
                        }
                        if (part === formParts[formParts.length - 1]) {
                            part.style.setProperty('border-bottom', '1px solid #dbe4ef', 'important');
