...
APP_BUILD = "Codex 2026-05-23 lot polish"
            ...
            if (addMarker) {
                ...
                if (lotBlock && markerChild) {
                    ...
                    formParts.forEach(function(part) {
                        ...
                        part.style.setProperty('background', '#e6f0ff', 'important');
                        ...
                        part.style.setProperty('padding', '0.25rem 1.35rem', 'important');
                        ...
                        if (part === formParts[0]) {
                            ...
                            part.style.setProperty('border-radius', '16px 16px 0 0', 'important');
                            part.style.setProperty('padding-top', '1rem', 'important');
                            part.style.setProperty('box-shadow', 'inset 0 1px 0 rgba(15,23,42,0.16)', 'important');
                        }
                        if (part === formParts[formParts.length - 1]) {
                            part.style.setProperty('border-bottom', 'none', 'important');
                            part.style.setProperty('border-radius', '0 0 16px 16px', 'important');
                            part.style.setProperty('padding-bottom', '1rem', 'important');
                            part.style.setProperty('box-shadow', 'inset 0 -1px 0 rgba(15,23,42,0.16)', 'important');
                        }
